...
@WebMvcTest(PutUserManagerController.class)
class PutUserManagerControllerTest {
    @MockitoBean
    private UpdateUserManagerUseCase updateUserManagerUseCase;
    @Autowired
    ...
    @Test
    @DisplayName("should update user manager successfully when usertype is 1 and return 200 OK")
    void shouldUpdateUserManagerSuccessfullyWhenUserTypeIs1() throws Exception {
            ...
            mockMvc.perform(put("/api/v1/user-managers/" + userManagerId)
                    ...
                    .andExpect(jsonPath("$.password").value("Abc1234."))
                    .andExpect(jsonPath("$.micronPass").value("Abc123."))
    ...
    @Test
    @DisplayName("should update user manager successfully and return 200 OK")
    void shouldUpdateUserManagerSuccessfullyWhenUserTypeIs2() throws Exception {
        UUID userManagerId = UUID.randomUUID();
